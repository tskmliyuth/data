...
$.extend($.validator, {
	...
	messages: {
		...
		maxlength: $.format("<Br />* No more than {0} characters."),
		minlength: $.format("<Br />* At least {0} characters."),
		rangelength: $.format("<Br />* Please enter a value between {0} and {1} characters long."),
		range: $.format("<Br />* Please enter a value between {0} and {1}."),
		max: $.format("<Br />* Please enter a value less than or equal to {0}."),
		min: $.format("<Br />* Please enter a value greater than or equal to {0}.")
	},
