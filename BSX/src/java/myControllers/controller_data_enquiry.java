...
@WebServlet(name = "controller_data_enquiry", urlPatterns = {"/enquiry"})
public class controller_data_enquiry extends HttpServlet {
...
private void LoadNewPage(clsMain myClsMain,clsDataBase myCls){
	String myBodyScript = myClsMain.getContentFromFile("DATA_ENQUIRY_FORM.html");
...
private void myBtSubmit_Click(clsMain myClsMain,clsDataBase myCls){
	...
	myDATA_ENQUIRY.setENQY_CONTACTNAME(myENQ_NAME);
        ...
        myDATA_ENQUIRY.setENQY_STATUS("1");
         myDATA_ENQUIRY.setENQY_AUTHORIZERID("-1");
